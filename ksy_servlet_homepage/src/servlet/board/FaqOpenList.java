...
/**
 * Servlet implementation class FaqOpenList
 */
@WebServlet("/FaqOpenList")
public class FaqOpenList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//******** page 시작 *******/
			...
			request.setAttribute("igal",igal);
			RequestDispatcher dispatcher = request.getRequestDispatcher("/board/faq/faq_r.jsp");
